...
setup_environment() {
    ...
    cd ../datura-challenge-by-sebastian-gallardo

    # Install the datura-challenge-by-sebastian-gallardo python package
...
## Setup localnet
# assumes we are in the datura-challenge-by-sebastian-gallardo/ directory
